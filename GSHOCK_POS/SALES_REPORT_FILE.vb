...
Public Class SALES_REPORT_FILE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSHOCK_POS.SALES_REPORT_FILE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALES_REPORT_FILE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALES_REPORT_FILE = New SALES_REPORT_FILE()
        rpt.Site = Me.Site
        Return rpt
    End Function
